...
public class CatalogueController {
	...
	public CatalogModel getDefaultResponse(@PathVariable("userId") String userId){
		List<CatalogItem> list=new ArrayList<CatalogItem>();
		list.add(new CatalogItem("No movie","No description", 0));
		return new CatalogModel("Hey User",list);
